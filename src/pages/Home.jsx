      ...
      <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between">
        ...
        <div className="flex flex-row gap-7 mt-8">
          <CTAButton active={true} linkto={"/signup"}>
            Learn More{" "}
            {/* learn more is the children can pass it in the prop and writing children*/}
          </CTAButton>
        ...
        {/* Video */}
        <div className="mx-3 my-12 shadow-blue-200 w-[70%] shadow-[10px_-5px_40px_-5px] relative">
          <video
...
// --------------------------
//why tailwind me classname hai and class nhi hai
//The only reason behind the fact that it uses className over class is that the class is a reserved keyword in JavaScript
//and since we use JSX in React which itself is the extension of JavaScript,so we have to use className instead of class attribute.

// Put group in the parent element and group-hover: in all those child elements where we want the style on hover,

//A <Link> is an element that lets the user navigate to another page by clicking or tapping on it.
//The `<Link>` Component in React Router does the same thing as the `<a>` tag in HTML.
//  -- Why use link instead of a in React ? --
//Note: Use the NavLink or Link when you need links that are routing to pages that belong to your application.
//For external links, a is preferrable.
...
//Learn More
//</CTAButton>
// iss button ka children hai learn more
