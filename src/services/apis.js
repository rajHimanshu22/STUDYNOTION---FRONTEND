// iss file me wo links mention kr skte hai ki konse link pr call krne jana hai
//const BASE_URL = "https://localhost:4000/api/v1";

const BASE_URL = process.env.REACT_APP_BASE_URL; //yaha REACT_APP lgana important hai
